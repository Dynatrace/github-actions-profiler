      ...
      <Page.Main>
        <Flex justifyContent='center' width='100%'>
          <Flex flexDirection='column' padding={32} gap={16} maxWidth='960px'>
            ...
            <List ordered={false}>
              <Text textStyle="base">How business events can be used to analyze GitHub Actions workflows</Text>
              <Text textStyle="base">How notifications can be triggered by business events</Text>
              <Text textStyle="base">How to fetch data with Dynatrace Query Language (DQL)</Text>
              <Text textStyle="base">
